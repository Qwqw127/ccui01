...
import { DLocale } from '@ccui/locale'
import enUS from '@ccui/locale/lang/en-us'
import zhCN from '@ccui/locale/lang/zh-cn'
...
const switchLang = () => {
  if (currentLang.value === ZH_CN) {
    DLocale.use(EN_US, enUS);
    currentLang.value = EN_US;
  } else {
    DLocale.use(ZH_CN, zhCN);
      ...
      <div class="flex items-center">
        ...
        <div class="custom-nav flex items-center ml-l">
          ...
          <a class="custom-nav-item ml-m" style="font-size: 0;user-select:none"
            href="https://github.com/DevCloudFE/vue-ccui" target="_blank">
            <svg viewBox="0 0 20 20" width="18" height="18">
              <path fill="var(--ccui-text, #252b3a)"
