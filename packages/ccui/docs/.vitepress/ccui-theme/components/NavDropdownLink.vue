...
<template>
  <div class="nav-dropdown-link" :class="{ open }">
    ...
    <ul class="dialog">
      <li v-for="cell in item.items" :key="cell.text" class="dialog-item">
...
@media (min-width: 720px) {
  .dialog {
    ...
    padding: 12px 0;
    min-width: 128px;
    background-color: $ccui-connected-overlay-bg;
    box-shadow: $ccui-shadow-length-connected-overlay $ccui-shadow;
  }
}
</style>
