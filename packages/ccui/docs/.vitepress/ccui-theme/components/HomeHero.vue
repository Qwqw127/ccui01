...
<template>
  <header v-if="showHero" class="home-hero">
    <div class="ccui-banner-card">
      <div class="ccui-banner-card-left">
      ...
      <div class="ccui-banner-card-right">
...
.action :deep(.item) {
  ...
  padding: 0 30px;
  line-height: 44px;
  font-size: $ccui-font-size-page-title;
  font-weight: 500;
  color: $ccui-light-text;
  background-color: $ccui-primary;
  border: 1px solid $ccui-primary;
...
.action :deep(.item:hover) {
  ...
  border-color: $ccui-primary-hover;
}
...
.ccui-banner-card {
  ...
  .ccui-banner-card-left {
    ...
    .subtitle {
      margin-top: 16px;
      font-size: $ccui-font-size-modal-title;
    }
  }

  .ccui-banner-card-right {
    flex: 1;
...
@media (max-width: 1440px) and (min-width: 1280px) {
  .ccui-banner-card .ccui-banner-card-right img {
    right: -40px;
  }
}
...
@media (max-width: 840px) {
  ...
  .ccui-banner-card {
    ...
    .ccui-banner-card-left .design-title {
      font-size: 64px;
    }

    .ccui-banner-card-right img {
      width: 100%;
      position: static;
    }
